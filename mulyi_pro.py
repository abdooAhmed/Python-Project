...
char3=[['ه','ب'],['ي','ا'],['س','ح'],['د','ر'],['ث','ص'],['م','ط'],['ع','ف'],['ك','ض']]
char2=[['ه','ب'],['ي','ا'],['س','ح'],['د','ر'],['ث','ص'],['م','ط'],['ع','ف'],['ك','ض']]
char=['','ا','ب','ت','ث','ج','ح','خ','د','ذ','ر','ز','س','ش','ص','ض','ط']
char1=['ا','ب','ت','ث','ج','ح','خ','د','ذ','ر','ز','س','ش','ص','ض','ط','ظ','ع','غ','ف','ق','ك','ل','م','ن','ه','و','ي']
bordwidth=4
bordheight=4
titlesize=80
titlesize1=60
...
bacgraound = pygame.image.load('i1.jpg')
...
def makeText(text, col, bcol, top, left):
    textsur = basicfont1.render(text, True, col, bcol)
